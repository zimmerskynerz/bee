            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="chat-system">
                        ...
                        <!-- </div> -->
                        <div class="chat-box" style="height: calc(100vh - 195px);border-radius:6px">
                            ...
                            <div class="chat-box-inner" style="height: 100%;">
                                ...
                                <div class="chat-conversation-box" style="height: calc(100% - 59px);">
...
<script>
    $(document).ready(function() {
        $('#formChat').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>/konsumen/chat/store",
                data: $(this).serialize(),
